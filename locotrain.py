...
class Workspace:
    ...
    def setup(self):
        ...
        self.train_env = dmc.make(self.cfg.task_name, self.cfg.frame_stack,
                                  self.cfg.action_repeat, self.cfg.seed, type='video', difficulty='original')
    ...
    def train(self):
        ...
        while train_until_step(self.global_step):
            if time_step.last():
                ...
                if self.cfg.save_snapshot and (self.global_step % int(5e3) == 0):
                    self.save_snapshot()
                episode_step = 0
                episode_reward = 0
...
def main(cfg):
    from locotrain import Workspace as W
    root_dir = Path.cwd()
    workspace = W(cfg)
